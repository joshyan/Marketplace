 ...
 */
class Junaidbhura_Jbmarketplace_Model_Convert_Parser_Csv extends Mage_Dataflow_Model_Convert_Parser_Csv
{
    protected $_fields;
    ...
    public function parse()
    {
        ...
        if (Mage::app()->getRequest()->getParam('files')) {
            if(Mage::helper('jbmarketplace')->isVendor()) {
                $file = Mage::app()->getConfig()->getTempVarDir().'/import/'.Mage::getSingleton( 'admin/session' )->getUser()->getUsername().'/'
